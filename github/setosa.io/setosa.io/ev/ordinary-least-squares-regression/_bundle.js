            ...
            App = React.createClass({
                ...
                render: function() {
                    return React.createElement("div", null, React.createElement("h3", null, "This explanation is interactive!"), React.createElement("p", null, React.createElement("i", null, "Dials"), " allow you to adjust scalar values.", React.createElement("img", {
                        ...
                        height: 310,
                        betas: this.state.betas
                    }), React.createElement("p", null, 'At some point, you probably asked your parents, "Where do betas come from?" Let\'s raise the curtain on how OLS finds its betas.'), React.createElement("p", null, "Error is the difference between prediction and reality: the vertical distance between a real data point and the regression line. OLS is concerned with the ", React.createElement("em", null, "squares"), " of the errors. It tries to find the line going through the sample data that minimizes the sum of the squared errors. Below, the squared errors are represented as squares, and your job is to choose betas (the slope and intercept of the regression line) so that the total area of all the squares (the sum of the squared errors) is as small as possible. That's OLS!"), React.createElement(RegressionAsNobsModule, {
                        points: this.state.leastSquaresPoints,
                    ...
                    }), React.createElement(LeastSquares3DModule, null), React.createElement("p", null, "Special thanks to ", React.createElement("a", {
                        href: "http://twitter.com/enjalot"
                    }, "Ian Johnson"), " for reviewing an earlier version of this explorable explanation and suggesting the idea of using GIFs to explain how the controls work."))
                }
            });
        ...
        var React = require("react"),
            ...
            LeastSquares3DModule = React.createClass({
                ...
                render: function() {
                    ...
                    }, React.createElement("p", null, "Now, real scientists and even sociologists rarely do regression with just one independent variable, but OLS works exactly the same with more. Below is OLS with two independent variables. Instead of the errors being relative to a line, though, they're now relative to a plane in 3D space. So now the job of OLS is to find the equation for that plane. The slice of the plane through each axis is shown in the first two figures."), React.createElement(LeastSquares, {
