...
var LeastSquares3DModule = React.createClass({
    ...
    _updateRegressionBeta0(val) {
        this._updateRegressionBeta(0, val)
    },
    _updateRegressionBeta1(val) {
        this._updateRegressionBeta(1, val)
    },
    _updateRegressionBeta2(val) {
        this._updateRegressionBeta(2, val)
    },
    _renderDial(opts) {
        var {
            dialHeight
        ...
        value = {
            this.state.regressionBetas[opts.betaIndex]
        }
        onChangeValue = {
            this['_updateRegressionBeta' + opts.betaIndex]
        }
        wrapInSVG = {
            false
        }
    ...
    render() {
        ...
        locationAccessor = {
            this._locationAccessorX1Y
        }
        onDragNob = {
            this._onDragPointX1Y
        }
        style = {
            {
                float: 'left'
        ...
        locationAccessor = {
            this._locationAccessorX2Y
        }
        onDragNob = {
            this._onDragPointX2Y
        }
        style = {
            {
                float: 'left'
        ...
        style = {
            ...
            p >
            Below, see
        if you can choose the betas to minimize the sum of squared errors. <
            /p> <
            p >
        ...
        betas = {
            [this.state.regressionBetas[0], this.state.regressionBetas[1]]
        }
        mode = 'point'
        xAxisLabel = 'x1'
        yAxisLabel = 'y'
        ...
        betas = {
            [this.state.regressionBetas[0], this.state.regressionBetas[2]]
        }
        mode = 'point'
        margins = {
            margins
        ...
        regressionNob = {
            this.state.regressionNob
        }
        regressionPlaneColor = {
            color.primary
        }
        betas = {
            this.state.regressionBetas
        }
        points = {
            this.state.points
        }
