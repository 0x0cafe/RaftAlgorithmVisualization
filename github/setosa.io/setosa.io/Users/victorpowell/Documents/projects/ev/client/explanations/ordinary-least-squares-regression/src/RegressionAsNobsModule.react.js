...
var RegressionAsNobsModule = React.createClass({
    ...
    render() {
        ...
        style = {
                ...
                d3.format('.2f')(this.state.betas[0])
            } < /text>
        ...
        style = {
                ...
                d3.format('.2f')(this.state.betas[1])
            } < /text>
        ...
        data = {
            this.state.leastSquaresErrors
        }
        valueAccessor = {
            this.props.leastSquaresValueAccessor
        }
        colorAccessor = {
            this.props.leastSquaresColorAccessor
        }
        /> <
        /div> <
        div style = {
